 ...
 * student JUnits that we provide should be thought of as a sanity check to help
 * you get started on the homework and writing JUnits in general.
 *
 * We highly encourage you to write your own set of JUnits for each homework to
 * cover edge cases you can think of for each data structure. Your code must
 * work correctly and efficiently in all cases, which is why it's important to
 * write comprehensive tests to cover as many cases as possible.
 *
 * @author CS 1332 TAs
 * @version 1.0
 */
public class ArrayListStudentTest {
    ...
    @Test(timeout = TIMEOUT)
    public void addAtNegative() {

        // Adding at negative should throw out of bounds
    ...
    @Test(timeout = TIMEOUT)
    public void addAtGreaterThanSize() {
        list.addAtIndex(0, "0a"); // 0a
        list.addAtIndex(1, "1a"); // 0a, 1a
        list.addAtIndex(2, "2a"); // 0a, 1a, 2a
        list.addAtIndex(3, "3a"); // 0a, 1a, 2a, 3a
        ...
        // Adding at greater than size should throw out of bounds
        Assert.assertThrows(IndexOutOfBoundsException.class,
    ...
    public void addAtIndexNull() {
        ...
        // Adding null data should throw IllegalArgumentException
    ...
    public void removeAtNegative() {
        ...
        // Removing at negative should throw out of bounds
        Assert.assertThrows(IndexOutOfBoundsException.class,
    ...
    @Test(timeout = TIMEOUT)
    public void removeAtGreaterThanSize() {
        list.addAtIndex(0, "0a"); // 0a
        list.addAtIndex(1, "1a"); // 0a, 1a
        list.addAtIndex(2, "2a"); // 0a, 1a, 2a
        list.addAtIndex(3, "3a"); // 0a, 1a, 2a, 3a
        ...
        // Removing at greater than size should throw out of bounds
        Assert.assertThrows(IndexOutOfBoundsException.class,
    ...
    @Test(timeout = TIMEOUT)
    public void removeFromFrontNoElements() {

        // Removing from front with no elements should throw
    ...
    @Test(timeout = TIMEOUT)
    public void removeFromBackNoElements() {

        // Removing from back with no elements should throw
        // NoSuchElementException
        Assert.assertThrows(NoSuchElementException.class,
                () -> list.removeFromBack());
    }
